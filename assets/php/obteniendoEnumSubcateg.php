<?php 
	...
	$consulta = mysqlI_query($conexion, "SELECT COLUMN_TYPE FROM information_schema.COLUMNS WHERE table_schema = 'pagina' AND TABLE_NAME = 'productos' AND column_name = 'subcategoria'"); //Con esta consulta se obtienen los valores para 'enum'; Sin embargo lo devuelve en un string asi:
